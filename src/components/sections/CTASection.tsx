  ...
  return (
    <section className="section-padding">
      <div className="container container-padding">
        <div className="relative rounded-2xl bg-gradient-to-br from-primary via-primary to-primary/80 px-8 py-16 md:px-16 md:py-20 overflow-hidden shadow-xl">
          {/* Decorative elements */}
          ...
          <div className="relative z-10 max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button 
                asChild 
                size="lg" 
                className="bg-background text-foreground hover:bg-background/90 h-12 px-8 rounded-lg shadow-lg"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 h-12 px-8 rounded-lg bg-transparent"
              >
